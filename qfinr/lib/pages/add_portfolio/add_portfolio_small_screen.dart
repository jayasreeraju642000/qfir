...
class AddPortfolioForSmallScreen extends StatefulWidget {
  MainModel model;

  final FirebaseAnalytics analytics;
  final FirebaseAnalyticsObserver observer;

  AddPortfolioForSmallScreen(this.model, {this.analytics, this.observer});

  @override
  State<StatefulWidget> createState() {
    return _AddPortfolioForSmallScreenState();
  }
}

class _AddPortfolioForSmallScreenState
    extends State<AddPortfolioForSmallScreen> {
      ...
      children: <Widget>[
        Container(
          margin: EdgeInsets.symmetric(
              vertical: getScaledValue(30), horizontal: getScaledValue(16)),
          child: Column(
        ...
        toolShortcut("assets/icon/icon_import_excel.png", "Import",
            "Import NSDL/CDSL pdf statements or Excel/csv files from your broker or using the simple qfinr excel template",
            navigation: '/portfolio_import_excel'),
        toolShortcut("assets/icon/icon_add_manually.png", "Add Manually",
            "Add/edit all holdings right here",
            navigation: "/add_portfolio_manually"),
        // toolShortcut("assets/icon/icon_statement.png", "Upload Statements",
        //     "Coming soon!"),
      ],
    );
  }
      ...
      child: widgetCard(
        ...
        child: Row(
            ...
            children: <Widget>[
              ...
              navigation != ""
                  ? Icon(Icons.chevron_right, color: Color(0xff959595))
                  : emptyWidget,
            ]),
      ),
    );
