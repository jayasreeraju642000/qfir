...
class DiscoverForMediumScreen extends StatefulWidget {
  final MainModel model;
  final FirebaseAnalytics analytics;
  final FirebaseAnalyticsObserver observer;

  DiscoverForMediumScreen(this.model, {this.analytics, this.observer});
  @override
  _DiscoverForLargeScreenState createState() => _DiscoverForLargeScreenState();
}

class _DiscoverForLargeScreenState extends State<DiscoverForMediumScreen> {
  ...
  Widget _buildContentText() {
    return Text(
      DiscoverStyles.marketTodayContentText,
  ...
  Expanded _buildBenchmarkColumnData(
    ...
    return Expanded(
      ...
      child: Column(
        ...
        children: [
          Text(
            '${dataMap[key].benchmark.toString()}',
