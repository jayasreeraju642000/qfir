...
// 					/* drawer: WidgetDrawer(), */
// 					appBar: commonAppBar(/* controller: controller,  */bgColor: Colors.white, actions: [
// 						GestureDetector(
// 							onTap: () => Navigator.pushReplacementNamed(context, widget.model.redirectBase),
// 							child: AppbarHomeButton(),
// 						)
// 					]),
// 					body: mainContainer(context: context, paddingLeft: getScaledValue(16), paddingRight: getScaledValue(16), containerColor: Colors.white, child: _buildBody())
// 				);
// 			}
// 		);
// 	}
...
// 								crossAxisAlignment: CrossAxisAlignment.start,
// 								children: <Widget>[
// 									Text("Import from Excel", style: importPortfolioHeading,),
// 									SizedBox(height: getScaledValue(3)),
// 									Text("Create a new portfolio by uploading an excel with all the holdings from your favourite broker, or via Qfinr template", style: importPortfolioBody),
// 								],
// 							),
// 						),
...
// 						Container(
// 							padding: EdgeInsets.symmetric(vertical: getScaledValue(30), horizontal: getScaledValue(33)),
...
// 								children: <Widget>[
// 									Image.asset('assets/icon/icon_email.png', width: getScaledValue(90),),
// 									SizedBox(height: getScaledValue(25)),
// 									Text("An email will be sent to your email address '"+ widget.model.userData.emailID +"' with steps to upload.", style: importPortfolioBody2, textAlign: TextAlign.center,)
// 								],
// 							),
// 						),
...
// 				gradientButton(context: context, caption: "Send Mail", onPressFunction: () => functionSendPortfolioImportSample()),
...
// 		showAlertDialogBox(context, '', 'An email will be sent to your verified email address with the steps to upload the excel');
