...
final log = getLogger('KnowFundReportForSmallScreen');

class KnowFundReportForSmallScreen extends StatefulWidget {
  ...
  KnowFundReportForSmallScreen(this.model,
      {this.analytics, this.observer, this.responseData});

  @override
  State<StatefulWidget> createState() {
    return _KnowFundReportForSmallScreenState();
  }
}

class _KnowFundReportForSmallScreenState
    extends State<KnowFundReportForSmallScreen>
    ...
    return ScopedModelDescendant<MainModel>(
      ...
      return Scaffold(
        ...
        appBar: !kIsWeb
            ...
            : PreferredSize(child: SizedBox(), preferredSize: Size(0.0, 0.0)),
        body: _buildBody(),
      );
    });
  }
    ...
    _children.add(Container(
      ...
      child: Stack(
        children: <Widget>[
          Positioned(
            child: Container(
                height: getScaledValue(widgetExpanded ? 185 : 135.0), // 185
  ...
  Widget analysisScore() {
    ...
    if (widget.responseData['response']['type'] == "fund") {
      ratingChildren.add(widgetRating(
          context: context,
          title: 'Return Rating',
          description:
      ...
      ratingChildren.add(widgetRiskRating(
          context: context,
          title: 'Risk Rating',
          description:
  ...
  Widget description() {
    ...
    for (int i = 0; i <= 5; i++) {
      if (fundData['data'].isNotEmpty &&
        ...
        _doPointers.add(bulletPointer(fundData['data']['w' + i.toString()],
      ...
      if (fundData['data'].isNotEmpty &&
        ...
        _dontPointers.add(bulletPointer(fundData['data']['nw' + i.toString()],
            bulletColor: colorBlue));
    }
    ...
    return Column(
      children: [
        _doPointers.isNotEmpty
            ...
            : emptyWidget,
        _doPointers.isNotEmpty && _dontPointers.isNotEmpty
            ? sectionSeparator()
            : emptyWidget,
    ...
    return Container(
        ...
        child: Column(
          children: <Widget>[
            ...
            //toolShortcut("assets/icon/icon_analyzer_style.svg", "Investment Styles", "Factor level breakdown of portfolios and funds to identify key drivers of returns and risks....", navigation: "/knowFundDetail/2"),
            toolShortcut(
