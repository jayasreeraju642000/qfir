...
class KnowFundReportForLargeScreen extends StatefulWidget {
  ...
  KnowFundReportForLargeScreen(this.model,
      {this.analytics, this.observer, this.responseData});

  @override
  State<StatefulWidget> createState() {
    return _KnowFundReportForLargeScreenState();
  }
}

class _KnowFundReportForLargeScreenState
    extends State<KnowFundReportForLargeScreen>
...
// NEW ONE
  ...
  PreferredSize _buildTabs() {
    return PreferredSize(
      ...
      child: KnowFundDetailForLargeScreen(
        widget.model,
