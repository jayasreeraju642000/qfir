...
class InvitationRefCodeSmall extends StatefulWidget {
  final MainModel model;

  final FirebaseAnalytics analytics;
  final FirebaseAnalyticsObserver observer;

  InvitationRefCodeSmall(
    this.model, {
    this.analytics,
    this.observer,
  });
  ...
  State<StatefulWidget> createState() {
    return _InvitationRefCodeSmallState();
  }
}

class _InvitationRefCodeSmallState extends State<InvitationRefCodeSmall> {
  ...
  Widget build(BuildContext context) {
    changeStatusBarColor(Color(0xfffcdf01));
    ...
    return ScopedModelDescendant<MainModel>(
      ...
      return Scaffold(
        ...
        appBar: commonScrollAppBar(
            ...
            title: pageType == 'referralHistory' ? "Refer" : "",
            bgColor: Color(0xfffcdf01),
            brightness: Brightness.light,
            // leading: pageType == "referralHistory"
            //     ? GestureDetector(
            //         onTap: () {
            //           // setState(() {
            //           //   pageType = "invitations";
  ...
  Widget _buildBody() {
    if (_loading) {
      ...
      return mainContainer(
          ...
          child:
              mainContainerChild()); //_autocompleteTextField(); //_buildBodyContent();
  ...
  //     child: Container(
  //         child: Image.asset(
  //       'assets/images/button_primary_button.png',
  //     )),
  //   );
  // }
  ...
  Widget _submitButton() {
    return gradientButton(
        ...
        onPressFunction: () {
          setState(() {
            //pageType = 'shareReferralCode';
            share_ref_code(context);
          });
          //getReferralHistory();
        });

    //buttonDisabled: _passcode == null || _passcode.length != 4);
  }
                    ...
                    children: [
                      Container(
                        ...
                        child: CircleAvatar(
                          ...
                          minRadius: 40.0,
                          child:
                              Text(getFirstCharString(element), style: body2),
                        ),
                      ),
                      SizedBox(
                        width: 16,
