...
class _PortfolioChartState extends State<PortfolioChart> {
      ...
      showAnalysisButton
          ? Container(
              ...
              child: gradientButton(
                  context: context,
                  caption: "Analyze",
                  onPressFunction: () => analyzePortfolio()),
            )
          : Container()
    ]);
  }
  ...
  Widget fundInfo() {
    ...
    // List zones = responseData['response']['portfolioDetails']['zone'].split('_');
    return Container(
        color: Colors.white,
        padding: EdgeInsets.symmetric(
            vertical: getScaledValue(20), horizontal: getScaledValue(18)),
        child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Expanded(
            ...
            children: [
              Text(
                  responseData['response']['portfolioDetails']
                      ['portfolio_name'],
                  style: headline1),
              ...
              Row(
                ...
                children: [
                  Row(
                    children: [
                      Text(
                          responseData['response']['navGraphData']['value']
                              ['value'],
                          style: bodyText10),
                      (responseData['response']['navGraphData']['value']
                                  ['change_sign'] ==
              ...
              /* SizedBox(height: getScaledValue(5)),
								responseData['response']['details']['core2'] != null ? Row(
									children: [
										Text("Category: ", style: bodyText4),
										Text(responseData['response']['details']['core2'], style: bodyText10),
									],
								) : emptyWidget,
								SizedBox(height: getScaledValue(5)),
								responseData['response']['details']['sector'] != null ? Row(
									children: [
										Text("Sector: ", style: bodyText4),
										Text(responseData['response']['details']['sector'], style: bodyText10),
									],
								) : emptyWidget */
            ],
          )),
