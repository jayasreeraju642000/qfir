...
import 'package:qfinr/pages/fund_info/fund_info_styles.dart';
...
import 'components/fund_info_components.dart';

final log = getLogger('FundInfo');

class FundInfoForLargeScreen extends StatefulWidget {
  ...
  FundInfoForLargeScreen(this.model, {this.analytics, this.observer, this.ric});

  @override
  State<StatefulWidget> createState() {
    return _FundInfoForLargeScreenState();
  }
}

class _FundInfoForLargeScreenState extends State<FundInfoForLargeScreen>
  ...
  Widget build(BuildContext context) {
    return ScopedModelDescendant<MainModel>(
      builder: (BuildContext context, Widget child, MainModel model) {
        return PageWrapper(
          child: Scaffold(
            backgroundColor: FundInfoStyles.backgroundColor,
            key: _scaffoldKey,
            drawer: WidgetDrawer(),
            appBar: _buildAppBar(),
            body: _buildBody(),
  ...
  SingleChildScrollView _buildChildView() {
    return SingleChildScrollView(
      child: Padding(
        ...
        child: _buildFundInfoContent(),
      ),
    );
  }

  Widget _buildFundInfoContent() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            responseData['response']['details']['ticker'] ?? "",
                            style: bodyText4,
                          ),
                          Text(
                            responseData['response']['details']['name'],
                            style: headline1,
                          ),
                        ],
                      ),
                  ...
                  children: [
                    Expanded(
                      child: Row(
                        children: [
                          Text(
                            responseData['response']['details']['type'] ==
                                    "Funds"
                                ? "NAV: "
                                : "Price: ",
                            style: bodyText4,
                ...
                responseData['response']['details']['core2'] != null
                    ? Row(
                        children: [
                          ...
                          Text(
                            responseData['response']['details']['core2'],
                            style: bodyText10,
                          ),
                        ],
                      )
                ...
                responseData['response']['details']['sector'] != null
                    ? Row(
                        children: [
                          ...
                          Text(
                            responseData['response']['details']['sector'],
                            style: bodyText10,
                          ),
                        ],
                      )
        ...
        children: <Widget>[
          Row(
            ...
            children: <Widget>[
              ...
              GestureDetector(
                onTap: () => FundInfoComponents.showPopUp(context),
