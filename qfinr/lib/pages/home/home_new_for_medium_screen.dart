...
class DashBoardTablet extends StatefulWidget {
  ...
  DashBoardTablet(this.model, {this.analytics, this.observer});
...
class _DashBoardState extends State<DashBoardTablet>
  ...
  void callTabData() async {
    setState(() {
      dataMap = indicesResponse.response.toJson();
      dataMap.forEach((key, value) {
        myList.add(value.zone.toString().toUpperCase());
      });
  ...
  validateIP(ipv4) async {
    ...
    //response_ip_v = await widget.model.validateIP('119.73.137.211'); // singapore ip
...
// TODO : portfoliosTab --------------- : shariyath
  ...
  Widget portfoliosTab() {
    ...
    _children.add(SizedBox(height: getScaledValue(20)));
                      ...
                      children: [
                        ...
                        MouseRegion(
                          ...
                          child: GestureDetector(
                            ...
                            child: Text(
                                notificationList.length > 0 ? 'View all >' : "",
                                style: heading_alert_view_all),
                          ),
                        )
                      ],
  ...
  Widget notificationContainer() {
    ...
    if (notificationListReverse.length > 0) {
      for (int i = 0; i < notificationListReverse.length; i++) {
        _children.add(notificationRow(notificationListReverse[i]));
      }
      ...
      Container(
          ...
          child:
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: <
                  Widget>[
            SizedBox(height: getScaledValue(23)),
                        ...
                        children: [
                              ...
                              children: [
                                ...
                                TextSpan(
                                  ...
                                  style: TextStyle(
                                      ...
                                      letterSpacing: 0.25,
                                      color:
                                          widget.model.userPortfolioValue['day']
                                                      ['change_sign'] ==
                                                  "up"
                                              ? Color(0xff30c50c)
                                              : Color(0xffc42f2f)),
                          ...
                          Text(
                              ...
                              style: TextStyle(
                                  ...
                                  fontFamily: 'nunito',
                                  letterSpacing: 0.29,
                                  color: widget.model.userPortfolioValue['day']
                                              ['change_sign'] ==
                                          "up"
                                      ? Color(0xff30c50c)
                                      : Color(0xffc42f2f))),
                    ...
                    Expanded(
                      ...
                      child: Container(
                        ...
                        children: [
                          ...
                          Text(
                              removeDecimal(
                                  widget.model.userPortfolioValue['month']
                                      ['change_difference']),
                              style: TextStyle(
                                  fontSize: ScreenUtil().setSp(18.0),
                                  fontWeight: FontWeight.w600,
                    ...
                    Expanded(
                      ...
                      child: Container(
                        ...
                        children: [
                          ...
                          Text(
                              removeDecimal(
                                  widget.model.userPortfolioValue['year']
                                      ['change_difference']),
                              style: TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.w600,
                                  fontFamily: 'nunito',
                                  letterSpacing: 0.29,
                                  color: widget.model.userPortfolioValue['year']
                                              ['change_sign'] ==
                                          "up"
                                      ? Color(0xff30c50c)
                                      : Color(0xffc42f2f))),
        ...
        children: <Widget>[
          Container(
            ...
            padding: EdgeInsets.symmetric(
                ...
                EdgeInsets.only(
                    left: getScaledValue(25), right: getScaledValue(25)),
...
class SimpleLineChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Container(
        height: PlatformCheck.isSmallScreen(context) ? 155.0 : 155.0,
        child: !kIsWeb
            ? ShaderMask(
