...
import 'package:qfinr/pages/analyse/details/portfolio_analyzer_detail_for_medium.dart';
...
class PortfolioAnalyzerReportMedium extends StatefulWidget {
  MainModel model;
  ...
  PortfolioAnalyzerReportMedium(this.model,
      {this.analytics,
      this.observer,
      this.responseData,
...
class _PortfolioAnalyzerReportState
    extends State<PortfolioAnalyzerReportMedium> {
...
//widget.model.userPortfoliosData['portfolio_zone'].split('_');
  ...
  Widget _portfolioAnalyzerDetails() {
    return PreferredSize(
        preferredSize: Size(MediaQuery.of(context).size.width,
            MediaQuery.of(context).size.height),
        child: PortfolioAnalyzerDetailMedium(widget.model,
