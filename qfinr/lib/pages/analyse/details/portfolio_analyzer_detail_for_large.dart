...
//
class PortfolioAnalyzerDetailLarge extends StatefulWidget {
  MainModel model;
  ...
  PortfolioAnalyzerDetailLarge(this.model,
      {this.analytics,
      this.observer,
      this.responseData,
...
class _PortfolioAnalyzerDetailState extends State<PortfolioAnalyzerDetailLarge>
