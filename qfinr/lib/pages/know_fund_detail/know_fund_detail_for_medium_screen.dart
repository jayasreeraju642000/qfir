...
class KnowFundDetailForMediumScreen extends StatefulWidget {
  ...
  KnowFundDetailForMediumScreen(this.model,
      {this.analytics, this.observer, this.responseData, this.tabIndex});

  @override
  State<StatefulWidget> createState() {
    return _KnowFundDetailForMediumScreenScreenState();
  }
}

class _KnowFundDetailForMediumScreenScreenState
    extends State<KnowFundDetailForMediumScreen>
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 20),
          Text(
            'Based on this risk profile generally investors having 5 year investment period have \nrisk (volatility) in the \nrange of ${roundDouble(_formResponseData['stdevData'][2][1], decimalLength: 1)}-${roundDouble(_formResponseData['stdevData'][4][1], decimalLength: 1)}% with expected annual return in the range ${roundDouble(_formResponseData['yieldData'][2][1], decimalLength: 1)}-${roundDouble(_formResponseData['yieldData'][4][1], decimalLength: 1)}%.\n\n\nFund has risk (volatility) of ${roundDouble(statsData['stddev'], postFix: "%", decimalLength: 1)} and annual expected returns of ${roundDouble(statsData['emean'], postFix: "%", decimalLength: 1)}',
